...
import top.overlink.read.help.storage.BackupConfig
...
import top.overlink.read.utils.toEditable
...
class BackupConfigFragment : PreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<top.overlink.read.lib.prefs.Preference>("web_dav_restore")
            ?.onLongClick {
                restoreFromLocal()
                true
            }
