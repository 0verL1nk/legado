...
object RhinoClassShutter : ClassShutter {
    ...
    private val protectedClassNamesMatcher by lazy {
        listOf(
            ...
            "top.overlink.read.data.AppDatabase",
            "top.overlink.read.data.AppDatabase_Impl",
            "top.overlink.read.data.AppDatabaseKt",
            "top.overlink.read.utils.ContextExtensionsKt",
